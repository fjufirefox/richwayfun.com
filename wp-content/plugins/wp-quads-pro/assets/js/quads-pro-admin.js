...
jQuery(document).ready(function ($) {
    ...
    function quads_delete_new_design_ad(ad_number){

        var data = {
            action: 'quads_delete_new_design_ad',
            nonce: quads.nonce,
            ad_number: ad_number
        };
    ...
    jQuery('.quads-form-table').on('click', '.quads-delete-ad', function (e) {
        ...
        var ad_number         = parentContainerID.replace("quads-togglead", '');
        if(ad_number){
            quads_delete_new_design_ad(ad_number);
        }
        // Remove Header
